  ...
  {
    {
      ...
      335, 185, 0, 0,  58, 234, 149, 258, 335, 15, 4, 25, 10, 25, 29,
        2, 2, 2, 2, 100, 1, 1, 1, 0, 5, 0, 16, 25, 0x77F, 0, 0, "Speed", 0, 0,
      {{0xFF, 0xFF, 0xFF}, {0x00, 0xFF, 0x00}, {0x00, 0x8A, 0xFF, 0x95},
...
static const GUI_WIDGET_CREATE_INFO _aDialogArc[] = {
  ...
  { CHECKBOX_CreateIndirect, NULL, GUI_ID_USER+0,  222,  11,  10,  10 },
  { CHECKBOX_CreateIndirect, NULL, GUI_ID_USER+1,  222,  35,  10,  10 },
  { CHECKBOX_CreateIndirect, NULL, GUI_ID_USER+2,  222,  59,  10,  10 },
  { CHECKBOX_CreateIndirect, NULL, GUI_ID_USER+3,  222,  83,  10,  10 },
  { CHECKBOX_CreateIndirect, NULL, GUI_ID_USER+4,  222, 107,  10,  10 }
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogGrad[] = {
  ...
  { CHECKBOX_CreateIndirect, NULL, GUI_ID_USER+0,  222,  11,  10,  10 },
  { CHECKBOX_CreateIndirect, NULL, GUI_ID_USER+1,  222, 107,  10,  10 }
};
...
*       SeggerLogo
*/
static const GUI_COLOR ColorsSeggerLogoBlue[] = {
     0xFFFFFF,0xFCF9F9,0xFFF0F0,0xD9D9D9
    ,0xDEBEBF,0xFF8E8E,0x989A9C,0xFF5252
    ,0xFF2929,0xFF0F0F,0xFF0000,0x515356
    ,0x212327,0x0F0F0F,0x090909,0x000000
};

static const GUI_LOGPALETTE PalSeggerLogoBlue = {
  16,	/* number of entries */
  0, 	/* No transparency */
  &ColorsSeggerLogoBlue[0]
};

static const unsigned char acSeggerLogoBlue[] = {
  
};
...
static GUI_FLASH const unsigned char acMap[] = {
...
*       _InvalidateScale
*/
void _InvalidateScale(SCALE* pObj) {
  if (pObj->hMemDev) {
...
*       _SetClipRect
*/
static const GUI_RECT* _SetClipRect(int x0, int y0, int x1, int y1) {
  GUI_RECT r;
  r.x0 = x0;
  r.y0 = y0;
  r.x1 = x1;
  r.y1 = y1;
  return WM_SetUserClipRect(&r);
}
...
static void _MoveMap(WM_HWIN hMap) {
  ...
  int Dif  = (Time - _NaviMap.PrevTime) / (60000 / _NaviMap.PPM);
...
static void _DrawText(const SCALE* pObj) {
  if (pObj->Flags & (1 << FLAG_SHOW_TEXT)) {
    ...
    GUI_SetFont(&GUI_Font8x8);
    GUI_SetTextMode(GUI_TEXTMODE_TRANS);
    w = GUI_GetStringDistX(pObj->acText);
    x = pObj->x0;
...
static void _DrawNeedle(const SCALE* pObj, int Index) {
  int NumPoints, Radius;
  GUI_MEMDEV_Handle hMemDev, hPrev;
  GUI_RECT r;
  #if SHOW_RECTS
...
static void _cbBkWindow(WM_MESSAGE* pMsg) {
  ...
  case WM_PAINT:
    if (!_hBkMemDev) {
      ...
      GUI_SetBkColor(GUI_BLACK);
      GUI_Clear();
      GUI_DrawBitmap(&bmSeggerLogoBlue, 574, 254);
...
static void _EPSON_Demo(void) {
  ...
  /* Create framewindow */
  hFrame = FRAMEWIN_Create("Controls", &_cbFrameWin, WM_CF_SHOW, 5, 290, 370, 184);
  FRAMEWIN_SetActive(hFrame, 1);
  FRAMEWIN_SetMoveable(hFrame, 1);
  /* Create multipage */
  hMultiPage = MULTIPAGE_Create(5, 5, 280, 154, hFrame, 0, WM_CF_SHOW, 0);
  ...
  hWinMap  = FRAMEWIN_Create("Map to Segger Hilden", &_cbWinMap, WM_CF_SHOW, 385, 290, 250, 184);
