...
*
----------------------------------------------------------------------
File        : LCDConf_1375_T8_T320x240.h
...
#define LCD_REG1 ((1<<7)                                       /*  Mode reg 0.  Set to TFT            */            \
                 |(0<<6)                                       /*  don't care for TFT                 */            \
                 |(0<<5)                                       /*  don't care for TFT                 */            \
                 |(0<<4)                                       /*  1 = FPLINE active high             */            \
                 |(0<<3)                                       /*  1 = FPFRAME active high            */            \
                 |(0<<2)                                       /*  1 = FPSHIFT masked during non display period */  \
                 |(0<<1)                                       /*  don't care for TFT                 */            \
                 |(1<<0))                                      /*  1 = 12 bit TFT ( 0 = 9 bit TFT )   */
...
#define LCD_REG7 (1)                                           /* FPLine start position (TFT only) */
#define LCD_REG8 (12)                                          /* H.non display period =((LCD_REG8+4)*8) max. value = 31 */
#define LCD_REG9 (52)                                          /* FPFrame start pos.    (TFT only) */
#define LCD_REGA (60)                                          /* v.non display period  */
